  ...
  const tracking = await Promise.all([
    prisma.trackingEntry.create({
      data: {
        ...
        embarcador: 'LEISURE EXPORTING',
        consignatario: 'ARIANNA CORDERO MARTINEZ',
        carnetPrincipal: '94111138336',
        rawData: 'LEISURE EXPORTING\tLEISURE\t\tCPK-0266228\tEMBARCADO\tSí\tCPK-323\tREGULA/(SEGU 5278396)/(CWPS26188262)\tENVIO\tACEITE DE MOTOR 4 L\t11481\t2026-04-13\tARIANNA CORDERO MARTINEZ\t\t94111138336\tCALLE TOMAS...\t54357818\tROLANDO AQUINO CANCIO',
      },
    }),
    prisma.trackingEntry.create({
      data: {
        ...
        rawData: 'LEISURE EXPORTING\tLEISURE\t\tCPK-0300455\tEN AGENCIA\tSí\tCPK-456\tREGULA/(SEGU 6278901)/(CWPS35012345)\tENVIO\tROPA Y ZAPATOS VARIOS\t11482\t2026-04-20\tMARIA GARCIA\t\t90011223344\tCALLE 10 #234\t55556789\tPEDRO GARCIA',
      },
    }),
    prisma.trackingEntry.create({
      data: {
        ...
        rawData: 'LEISURE EXPORTING\tLEISURE\t\tCPK-0199988\tENTREGADO\tSí\tCPK-789\tREGULA/(SEGU 4455678)/(CWPS29098765)\tENVIO\tEQUIPO DE AUDIO\t11480\t2026-03-25\tLUIS HERNANDEZ\t\t85099887766\tCALLE MARTI #100\t56672345\tJUANA HERNANDEZ',
      },
    }),
  ]);
