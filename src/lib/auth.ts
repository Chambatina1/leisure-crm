...
const COOKIE_NAME = "vuela_session";
const ALG = "HS256";
const ISSUER = "chambatina";
const AUDIENCE = "chambatina-app";
const EXPIRY = "7d";
...
const FALLBACK_SECRET = "chambatina-fallback-secret-2026-change-me";
...
export function getTokenFromRequest(request: NextRequest): string | undefined {
  // SOLO cookie. Sin fallback de header (eso era del modo prueba auto-login).
