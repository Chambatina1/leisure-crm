              ...
              <td className="hbl-box hbl-company" style={{ width: "55%" }}>
                {brands.length > 0 ? (
                  ...
                  <div className="hbl-fake-logo">
                    <div className="hbl-brand">GRUPO EMPRESARIAL</div>
          ...
          <tbody>
            <tr>
              <td className="hbl-box" style={{ width: "60%" }}>
                ...
                <b>GRUPO EMPRESARIAL</b><br />
                Operado por Grupo Empresarial<br /><br />
