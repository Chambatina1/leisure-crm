// Logo SVG del Chambatina — fondo transparente, color terracota.
export default function Logo({ height = 40 }: { height?: number }) {
  return (
    <svg viewBox="0 0 380 120" role="img" aria-label="Chambatina" height={height}>
      <g fill="#C23B22">
        <g>
        ...
        <g fontFamily="Arial, Helvetica, sans-serif" fontWeight="900">
          <text x="140" y="46" fontSize="34">CHAMBATINA</text>
